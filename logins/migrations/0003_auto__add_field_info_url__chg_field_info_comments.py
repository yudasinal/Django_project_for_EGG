...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Info.url'
        db.add_column(u'logins_info', 'url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # Changing field 'Info.comments'
        db.alter_column(u'logins_info', 'comments', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):
        # Deleting field 'Info.url'
        db.delete_column(u'logins_info', 'url')


        # Changing field 'Info.comments'
        db.alter_column(u'logins_info', 'comments', self.gf('django.db.models.fields.CharField')(max_length=500))
