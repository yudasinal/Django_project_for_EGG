...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.is_admin_approved'
        db.add_column(u'logins_customuser', 'is_admin_approved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.is_admin_approved'
        db.delete_column(u'logins_customuser', 'is_admin_approved')
    ...
    models = {
        ...
        u'logins.info': {
            ...
            'game': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['logins.Game']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organization_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'}),
